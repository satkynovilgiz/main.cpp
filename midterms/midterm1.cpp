...
// // Date: Feb 17, 2026
// // Course: CIS 22A
// // Description: De Anza Food Court Kiosk. This version allows a user to 
// // exit the program even if they haven't ordered anything (empty cart).
...
//     // 3. CHECK IF CART IS EMPTY BEFORE PROCEEDING
//     if (q1 == 0 && q2 == 0 && q3 == 0 && q4 == 0 && q5 == 0) {
//         cout << "\nCart is empty. Thank you for visiting De Anza Food Court!" << endl;
//         return 0; // Exits the program immediately
//     }

//     // 4. CUSTOMER TYPE (Only happens if they ordered something)
//     char type;
